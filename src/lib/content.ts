  ...
  sections: [
    ...
    },
    {
      ...
      children: [
        ...
        { label: "Media", href: "/media", image: "/images/testimonial-work-sample-wall-2.webp",
  ...
  spacesBySector: {
    ...
    Commercial: [
      ...
      { index: "02", name: "Lobby & Common Area",      href: "/spaces/lobby-common-area",    src: "/images/commercial-lobby-common-area-canva.webp",    alt: "A refined commercial lobby with a terrazzo reception desk and dark aggregate floor",
        material: "Savvanna",               materialSrc: "/images/material-surface-savvanna.webp", materialAlt: "Savvanna terrazzo surface with bold charcoal, grey-green, and warm beige aggregate on white" },
